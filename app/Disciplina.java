...
public class Disciplina {
	...
	public Disciplina(String nome, String departamento, String codigo, int creditosTeoria, int creditosPratica,
		...
		if (nome == null || codigo == null || creditosTeoria < 0 || creditosPratica < 0 || creditosExtensao < 0 || creditosEstudos < 0 ||
			...
			StringBuilder builder = criarMensagem(nome, codigo, creditosTeoria, creditosPratica, creditosExtensao,
					creditosEstudos);
	...
	private StringBuilder criarMensagem(String nome, String codigo, int creditosTeoria, int creditosPratica,
